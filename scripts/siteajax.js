...
function login(username, password){
    ...
    var url = WWW_ROOT + (dirfromroot == '' ? '' : '/' + dirfromroot);
...
function save(from, to, duplicate) {
    ajaxapi('/ajax/site_ajax.php','save_lesson_move','&from='+from+'&to='+to+'&duplicate='+duplicate,function(){if (xmlHttp.readyState == 4) { location.reload(); } }, true);
}
